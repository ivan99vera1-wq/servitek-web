...
export const company: Company = {
  ...
  values: [
    {
      title: "Confiabilidad y Disponibilidad",
      description: "Mantenemos la continuidad operativa de nuestros clientes con soluciones robustas y soporte técnico permanente."
    },
    {
      title: "Seguridad Exigente",
      description: "Cumplimos y superamos los más altos estándares de seguridad eléctrica e industrial."
    },
    {
      title: "Eficiencia y Sostenibilidad",
      description: "Optimizamos el consumo energético y promovemos soluciones sostenibles para la industria."
    },
    {
      title: "Excelencia Técnica e Innovación",
      description: "Aplicamos tecnología de vanguardia y conocimiento especializado en cada proyecto."
    },
    {
      title: "Transparencia y Compromiso Comercial",
      description: "Actuamos con integridad y compromiso en cada relación comercial."
    }
  ],
